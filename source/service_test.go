...
func testServiceSourceEndpoints(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			"SRV record without annotations",
			"",
			"",
			"testing",
			"foo",
		...
		{
			"SRV record with priority annotation set with no number",
			"",
			"",
			"testing",
			"foo",
			...
			map[string]string{
				hostnameAnnotationKey: 				"foo.example.org.",
				recordTypeAnnotationKey:    		"SRV",
				srvRecordTypePriorityAnnotationKey: "foo",
			},
			"",
			[]string{},
			[]string{"1.2.3.4"},
		...
		{
			"SRV record with weight annotation set with no number",
			"",
			"",
			"testing",
			"foo",
		...
		{
			"SRV record with port annotation set with no number",
			"",
			"",
			"testing",
			"foo",
		...
		{
			"SRV record with negative port number annotation",
			"",
			"",
			"testing",
			"foo",
		...
		{
			"SRV record with too high port number annotation",
			"",
			"",
			"testing",
			"foo",
		...
		{
			"SRV record with correct annotations",
			"",
			"",
			"testing",
			"foo",
			...
			map[string]string{
				hostnameAnnotationKey: 				"foo.example.org.",
				recordTypeAnnotationKey:    		"SRV",
				srvRecordTypePriorityAnnotationKey: "10",
				srvRecordTypeWeightAnnotationKey: 	"20",
			...
			[]*endpoint.Endpoint{
				{
					...
					Targets: endpoint.Targets{"10 20 443 1.2.3.4"},
